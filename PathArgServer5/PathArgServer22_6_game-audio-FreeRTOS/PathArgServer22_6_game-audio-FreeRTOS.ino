...
//        file_w2.close();  
    ...
    writeFile(LittleFS, "/sys/gif_count.txt", (char*)frame_index.c_str());
...
//             Serial.println("frame_info");
          ...
          Serial.println(frame_num);
          int frame_count = readFile(LittleFS, "/sys/gif_count.txt").toInt();
          Serial.println("frame_count[0]");
          Serial.println(frame_count);
          listDir(LittleFS, "/gif", 3);
          //Serial.println(readFile(LittleFS, "/gif/gif1.txt"));
