  ...
  if(click()){
      ...
      if (click_once_count==1){
           if (array[1]==0){
            ...
            else  drawArrayJpeg(icon2[0], icon2_size[0], 0, 0); // Draw a jpeg image stored in memory
            delay(100);
        }
      ...
      if (click_once_count==3){
          if (array[3]==0){
             ...
             array[3]=1;
             array[4]=0; }
             drawArrayJpeg(icon1[0], icon1_size[0], 0, 0); // Draw a jpeg image stored in memory
      ...
      if (click_once_count==4){
           ...
           if (array[4]==0){
             ...
             array[3]=0;  
             array[4]=1; } 
             drawArrayJpeg(icon3[0], icon3_size[0], 0, 0); // Draw a jpeg image stored in memory
